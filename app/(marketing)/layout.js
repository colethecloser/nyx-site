...
export const metadata = {
  ...
  description:
    'NYX-1 makes sleep radically more efficient, so you recover in less of it and wake fully restored. No stimulants. No crash. No debt to tomorrow.',
};
      ...
      <footer>
        <div className="wrap foot-in">
          ...
          <div className="foot-links">
            ...
            <a href="/cohort">Finance Cohort</a>
          </div>
